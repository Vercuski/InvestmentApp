...
public sealed record GetLatestBuyTradeSignalPointsRequest() : IMediatRQueryRequest<IEnumerable<TradeSignalPointPoco>>;
    ...
    : IMediatRQueryHandler<GetLatestBuyTradeSignalPointsRequest, IEnumerable<TradeSignalPointPoco>>
{
    ...
    {
        return await tradeSignalRepository.GetLatestBuyTradeSignalPointsAsync();
    }
}
